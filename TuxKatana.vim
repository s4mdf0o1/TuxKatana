...
badd +1 TuxKatana.py
badd +89 KatanaController.py
badd +1 params/config.yaml
badd +1 params/midi.yaml
badd +12 widgets/katana_switcher.py
badd +2 widgets/__init__.py
badd +1 widgets/katana_settings.py
badd +1 style.css
badd +0 params/sysex.yaml
badd +24 lib/config.py
badd +0 lib/__init__.py
badd +5 params/devices.yaml
badd +87 widgets/katana_debug.py
badd +0 widgets/presets.py
badd +0 lib/log_setup.py
badd +1 log_tool.py
badd +1 lib/log_tool.py
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 14 - ((12 * winheight(0) + 6) / 13)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 14
...
wincmd w
argglobal
if bufexists(fnamemodify("params/sysex.yaml", ":p")) | buffer params/sysex.yaml | else | edit params/sysex.yaml | endif
balt params/config.yaml
let s:cpo_save=&cpo
set cpo&vim
imap <buffer> <silent> <C-G>g <Plug>delimitMateJumpMany
...
wincmd w
argglobal
if bufexists(fnamemodify("params/config.yaml", ":p")) | buffer params/config.yaml | else | edit params/config.yaml | endif
balt params/devices.yaml
let s:cpo_save=&cpo
set cpo&vim
imap <buffer> <S-Tab> <Plug>delimitMateS-Tab
imap <buffer> <S-BS> <Plug>delimitMateS-BS
...
wincmd w
argglobal
if bufexists(fnamemodify("widgets/__init__.py", ":p")) | buffer widgets/__init__.py | else | edit widgets/__init__.py | endif
balt style.css
let s:cpo_save=&cpo
set cpo&vim
imap <buffer> <S-Tab> <Plug>delimitMateS-Tab
